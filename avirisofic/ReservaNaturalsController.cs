...
namespace TurismoAvesDB3.Controllers
{
    public class ReservaNaturalsController : Controller
    {
        ...
        {
            ViewData["CreadoPor"] = new SelectList(_context.Usuarios, "IdUsuario", "Nombre");
            ViewData["IdMunicipio"] = new SelectList(_context.Municipios, "IdMunicipio", "Nombre");
            return View();
        }

        public Microsoft.AspNetCore.Mvc.ViewFeatures.ViewDataDictionary GetViewData()
        {
            return ViewData;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdReserva,Nombre,Descripcion,Ubicacion,CupoDiarioDefault,Activa,IdMunicipio,CreadoPor,FechaCreacion,ImagenRef")] ReservaNatural reservaNatural, Microsoft.AspNetCore.Mvc.ViewFeatures.ViewDataDictionary createViewData)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CreadoPor"] = new SelectList(_context.Usuarios, "IdUsuario", "Nombre", reservaNatural.CreadoPor);
            ViewData["IdMunicipio"] = new SelectList(_context.Municipios, "IdMunicipio", "Nombre", reservaNatural.IdMunicipio);
            return View(reservaNatural);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdReserva,Nombre,Descripcion,Ubicacion,CupoDiarioDefault,Activa,IdMunicipio,CreadoPor,FechaCreacion")] ReservaNatural reservaNatural)
        {
            ...
            ViewData["CreadoPor"] = new SelectList(_context.Usuarios, "IdUsuario", "    ", reservaNatural.CreadoPor);
            ViewData["IdMunicipio"] = new SelectList(_context.Municipios, "IdMunicipio", "Nombre", reservaNatural.IdMunicipio);
            return View(reservaNatural);
        }
